...
public class ShowController {
    ...
    @PostMapping
    public CommonResponse<ShowResponseDto> addShow(@RequestBody ShowRequestDto dto) {
        return CommonResponse.success("Show added", showService.addShow(dto));
    }

    @GetMapping("/movie/{movieId}")
    public CommonResponse<List<ShowResponseDto>> getShowsByMovie(@PathVariable String movieId) {
        return CommonResponse.success("Shows fetched", showService.getShowsByMovie(movieId));
    }
}
/*
    //Create Show
